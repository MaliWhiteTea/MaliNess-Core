...
public final class PwarpRateLimiter {

    private final int maxFailures;
    private final long windowMillis;
    private final ConcurrentMap<UUID, FailureWindow> failures = new ConcurrentHashMap<>();

    public PwarpRateLimiter(int maxFailures, long windowMillis) {
