...
| # | Test | Beklenen | Durum |
|---|------|----------|-------|
| 8.1 | Home warmup varken `/warp Market` | Warp engellenir, eve gitme devam eder; "Eve ışınlanma bekleniyor." mesajı |[x]|
| 8.2 | Warp warmup varken `/home` | Home engellenir, warp devam eder; "Bir warp ışınlanması bekleniyor." mesajı |[x]|
...
```
[DÜZELTİLDİ] Admin + see-closed: kapalı warpa ışınlanırken onay sorusu; normal oyuncu → warp bulunamadı.
[DÜZELTİLDİ] [8.1] [8.2] Home/warp warmup çakışması: diğer komut engellenir (iptal yok); doğru lang mesajı gösterilir.
```
